...
class MenuWalker extends Walker_Nav_Menu {
    ...
    public function start_lvl( &$output, $depth = 0, $args = array() ) {
        ...
        $classes = array( 'absolute w-56 bg-inherit invisible transition duration-300 ease-in-out' );
        $classes[] = $depth > 0 ? 'left-full top-0' : '';
        $classes[] = $depth == 0 ? 'top-8' : '';
        /**
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        $class_names = $class_names ? ' class="relative ' . esc_attr( $class_names ) . '"' : '';
        ...
        if ( isset( $args->has_children ) && $args->has_children && 0 === $depth && $args->depth > 1 ) {
            ...
            if ( $depth > 0 ) {
                ...
                $atts['class'] = 'uppercase transition duration-300 ease-in-out font-bold text-primary hover:text-secondary nav-link py-2';
            }
        }
